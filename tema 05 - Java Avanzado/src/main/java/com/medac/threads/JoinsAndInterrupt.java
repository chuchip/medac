...
public class JoinsAndInterrupt implements  Runnable{
    static SimpleDateFormat sdf=new SimpleDateFormat("HH:mm:ss S");


    public static void main(String[] args) throws Throwable{
        Thread t1 = new Thread(new JoinsAndInterrupt(), "t1");
    ...
    public void run() {
        ...
        for (int n=0;n<50;n++)  {
            ...
            {
                System.out.println("Estoy interrumpido!"); // Esto nunca se llamara
            }
